...
class WordAdapter(options:FirebaseRecyclerOptions<Voca>):FirebaseRecyclerAdapter<Voca,WordAdapter.ViewHolder>(options) {
    ...
    interface OnItemClickListener{
        fun OnItemClick(holder: WordAdapter.ViewHolder, position:Int)
        fun OnStarClick(holder: WordAdapter.ViewHolder, view: View, position:Int)
        fun OnItemLongClick(holder: WordAdapter.ViewHolder, position:Int):Boolean
    }
    ...
    override fun onBindViewHolder(holder: WordAdapter.ViewHolder, position: Int, model: Voca) {
