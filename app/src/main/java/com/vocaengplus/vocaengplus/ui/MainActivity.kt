...
import com.vocaengplus.vocaengplus.adapter.bindingAdapter.setProfileImageUrl
...
import com.vocaengplus.vocaengplus.ui.login.LoginViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        lifecycleScope.launch {
            ...
            userInfo?.let { user ->
                user.photoUrl?.let {
                    headerImageView.setProfileImageUrl(it)
                }
