...
object Initialization { //singleton
    ...
    fun initUserData(nickname:String){
        ...
        val useraccount = UserAccount(firebaseUser?.email.toString(),nickname,uid.toString(),categorynames,categorydata)
        //UserData
        ...
        user.child("downloadData").child("토익 영단어").child("words").child("neighborhood").setValue(Voca("토익 영단어","neighborhood","동네",0))
